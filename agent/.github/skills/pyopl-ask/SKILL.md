...
3. Gather only relevant validation evidence.
...
4. Produce critical, specific feedback.
...
5. Propose revisions only when necessary or requested.
...
6. Validate every proposed revision.
