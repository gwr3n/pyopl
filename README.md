...
[![flake8](https://img.shields.io/badge/code%20style-flake8-blue?logo=python)](https://github.com/pycqa/flake8)
[![Ruff](https://img.shields.io/badge/lint-ruff-1f79ff?logo=python)](https://github.com/astral-sh/ruff) 
[![mypy](https://img.shields.io/badge/type--checked-mypy-blue?logo=python)](https://github.com/python/mypy) 
[![lizard](https://img.shields.io/badge/complexity-lizard-orange?logo=python)](https://github.com/terryyin/lizard)
...
[![AI-Assisted](https://img.shields.io/badge/code%20assistant-GitHub%20Copilot-24292e?logo=githubcopilot&logoColor=white)](https://github.com/features/copilot)
...
The following Colab notebook show how to solve the traditional Stigler's Diet Problem in PyOPL:
...
- **Exposed tools**:
  ...
  - **compare_model_strings_tool**: Compare two OPL models from strings using the selectable `concrete` or `abstract` strategy, matching the IDE's Compare models workflow. Concrete comparison can prove projected equivalence over shared binary variables when formulations use different continuous auxiliaries. Returns `strategy`, `status`, `equivalent`, `level`, `reason`, `proof_steps`, and `counterexample`.
